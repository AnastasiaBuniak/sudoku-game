# Gummy Sudoku — Store listing copy (English)

Use these strings in **App Store Connect** and **Google Play Console**.
Category: **Puzzle** · Age: **4+** · Not Kids Category (general audience)
...
(Google Play title max 30 characters — fits as-is)

---

## Subtitle (Apple) / Short description (Google)

**Apple subtitle** (max 30 characters):

```
Soft puzzles for kids
```
...
Open Gummy Sudoku, pick Animals or Numbers, and enjoy a sweet little puzzle break together.
```

---

## Keywords (Apple, comma-separated, max 100 characters, no spaces after commas preferred)

```
sudoku,kids,puzzle,animals,logic,brain,children,family,candy,numbers,learn
```
...
```
Welcome to Gummy Sudoku! Soft candy Sudoku with Animals and Numbers modes, gentle levels, sounds, and 8 languages.
```
