...
const fr: TranslationTree = {
  ...
  win: {
    ...
    unlockTitle: 'Nouveau niveau débloqué !',
    unlockBody: 'Bravo — tu as débloqué le niveau suivant',
    playUnlocked: 'Jouer %{level}',
  ...
  howToPlay: {
    ...
    step3Numbers: 'Chaque chiffre une seule fois dans chaque ligne, colonne et bloc',
    step3Animals: 'Chaque animal une seule fois dans chaque ligne, colonne et bloc',
